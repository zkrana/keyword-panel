                                ...
                                <div class="main-card mb-3 card">
                                    ...
                                    <?php if (!empty($successMessage)) { ?>
                                        <div class="success-message"><?php echo $successMessage; ?></div>
                                                <script>
                                                // Redirect to the add keyword page after a brief delay
                                                setTimeout(function() {
                                                    window.location.href = "addkeyword.php";
                                                }, 3000); // Redirect after 3 seconds (adjust the delay as needed)
                                            </script>
                                        <?php } ?>
                                        <form action="key-edit-op.php" method="post">
                                            <?php
                                            if (isset($_GET['id'])) {
                                                $id = $_GET['id'];
                                            }
                                            $select_keyword = "SELECT * FROM keywords WHERE id = $id";
                                            $keyword_data = mysqli_query($connect, $select_keyword);
                                            $count = mysqli_num_rows($keyword_data);
                                            if ($count > 0) {
                                                ...
                                                <tbody>
                                                    <tr>
                                                        <td>
                                                            ...
                                                            <input type="text" name="keyword_name" class="add-user" value="<?php echo $data['keyword_name']; ?>"/>
                                                        </td>
                                                        <td>
                                                            <label for="Keyword Url">Target Url</label>
                                                            <input type="text" name="k_url" class="add-user" value="<?php echo $data['keyword_url']; ?>"/>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td>
                                                            <input type="hidden" name="id" value="<?php echo $data['id']; ?>"> <!-- Hidden input for the ID -->
