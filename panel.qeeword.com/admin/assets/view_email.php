                            ...
                            <div class="col-md-12">
                                <div class="main-card mb-3 cardmain-card-dashboard overFlow">
                                    ...
                                    <div class="table-responsive">
                                        ...
                                        // Fetch the complete email for the specified email ID
                                        $emailBody = imap_body($imap, $emailID);
                                        $header = imap_headerinfo($imap, $emailID);
                                        
                                        // Close the mailbox connection
                                        imap_close($imap);
                                        
                                        // Display the complete email with sender information in a table format
                                        echo '<table class="table table-sm table-dark">';
                                        echo '<thead><tr><th>Sender Name</th><th>Sender Email</th><th>Date</th><th>Subject</th><th>Replay</th></tr></thead>';
                                        echo '<tbody>';
                                        echo '<tr>';
                                        echo '<td>' . $header->from[0]->personal . '</td>';
                                        echo '<td>' . $header->from[0]->mailbox . '@' . $header->from[0]->host . '</td>';
                                        echo '<td>' . date("Y-m-d H:i:s", strtotime($header->date)) . '</td>';
                                        echo '<td>' . $header->subject . '</td>';
                                        echo '<td><a href="replay_email.php?email_id=' . $emailID . '">Replay</a></td>'; // Add the "Replay" column
                                        echo '</tr>';
                                        echo '</tbody>';
                                        echo '</table>';
                                        ?>
                                        ...
                                        echo nl2br($emailBody); // Display the email body
                                        ?>
                                        </div>
