                        ...
                        <div class="app-page-title">
                            <div class="page-title-wrapper">
                                <div class="page-title-heading">
                                    ...
                                    <div>User Dashboard
                                        <div class="page-title-subheading">Welcome to qeeword user control panel.
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="row">
                            <div class="col-md-6 col-xl-5">
                                <div class="card mb-3 widget-content bg-midnight-bloom">
                                    <div class="widget-content-wrapper text-white">
                                        <div class="widget-content-left">
                                            <div class="widget-heading search-box"> 
                            ...
                            <div class="col-md-6 col-xl-5">
                                <div class="card mb-3 widget-content bg-arielle-smile">
                                    <div class="widget-content-wrapper text-white">
                                        ...
                                        <div class="widget-content-left">
                                        <div class="widget-heading search-boxes">
                                            <a style="margin: 0 auto; display: block;" href=" user-activity.php"><button  style="margin: 0 auto; display: block;" class="btn btn-primary user-add">  See User Activity </button></a>
                                        </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="col-md-6 col-xl-2">
                                <div class="card mb-3 widget-content bg-grow-early">
                                    <div class="widget-content-wrapper text-white">
                                        <a href="adduser.php"><button class="btn btn-primary user-add"> <i class="fas fa-user-plus"></i>  Add User</button></a>
                                    </div>
                                </div>
                            </div>
                        </div>
                                ...
                                <div class="main-card mb-3 card">
                                    <div class="card-header">User Table
                                        <div class="btns-center">
                                            ...
                                            if (!isset($_GET['reload'])) {
                                                echo '<meta http-equiv=Refresh content="4;url=manageuser.php">';
                                            } }?></h4>
                                        </div>
                                    ...
                                    <div class="table-responsive">
                                        <table class="table">
                                            ...
                                            <?php
                                            include ('config.php');
                                            $fetch_user = "SELECT * FROM user_table";
                                            $user_query = mysqli_query($connect, $fetch_user);
                                            ...
                                            if($count>0){
                                                ...
                                                <td><?php echo ucfirst($user_row['first_name'])." ".$user_row['last_name']; ?></td>
                                                <td><?php echo $user_row['username']; ?></td>
                                                <td><?php echo $user_row['user_email']; ?></td>
                                                <td><?php echo $user_row['user_role']; ?></td>
                                                <td class="user photo"><?php echo "<img width='100' height='100' src='img/uploads/user_photo/".$user_row['photo']."' >"; ?></td>
                                                <td><?php echo $user_row['status']; ?></td>
                                                <td> <a href="deleteops.php?id=<?php echo $user_row['id']; ?>" onclick="return confirm('Are you sure to delete?')"><button type="button" class="btn btn-warning">Delete</button></a> </td>
