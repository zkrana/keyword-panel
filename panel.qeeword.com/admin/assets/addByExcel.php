                                    ...
                                    <div class="card-header mb-card-h" style="display: flex; justify-content: space-between; align-items: center;">
                                        ...
                                        <?php
                                            ...
                                            if (isset($_SESSION['success_message'])) {
                                                ...
                                                $successMessage = ''; // Initialize or clear the success message
                                            }
                                            ...
                                            if (isset($_SESSION['error_message'])) {
                                                ...
                                                $errorMessage = ''; // Initialize or clear the error message
                                            }
                                        ?>
                                        <!-- Display the success message in green if it's not empty -->
                                        ...
                                        <!-- Display the error message in red (or current style) if it's not empty -->
