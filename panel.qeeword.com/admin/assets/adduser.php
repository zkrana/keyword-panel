                        ...
                        <div class="app-page-title">
                            <div class="page-title-wrapper">
                                <div class="page-title-heading">
                                    ...
                                    <div>Add User Panel
                                        <div class="page-title-subheading">Please fill all field carefully.
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="col-md-12">
                                <div class="main-card mb-3 card">
                                    ...
                                    <div class="table-responsive">
                                        <form action="user-ins.php" method="post" enctype="multipart/form-data">
                                            <table class="table">
                                                <tbody>
                                                    <tr>
                                                    <td>
                                                        <label for="First Name">First Name</label>
                                                        <input type="text" name="first_name" placeholder="First Name" class="add-user"/>
                                                    </td>
                                                    <td>
                                                        <label for="Last Name">Last Name</label>
                                                        <input type="text" name="last_name" placeholder="Last Name" class="add-user"/>
                                                    </td>
                                                    </tr>
                                                    <tr>
                                                    <td>
                                                        <label for="User Name">User Name</label>
                                                        <input type="text" name="username" placeholder="User Name" class="add-user"/>
                                                    </td>
                                                    <td>
                                                        <label for="User Password">User Password</label>
                                                        <input type="password" name="passcode" placeholder="User Password" class="add-user"/>
                                                    </td>
                                                    </tr>
                                                    <tr>
                                                    <td>
                                                        <label for="Email">Email</label>
                                                        <input type="email" name="email" placeholder="User Email" class="add-user"/>
                                                    </td>
                                                    <td>
                                                        <label for="User Role">User Role</label>
                                                        <select name="user_role" class="add-user">
                                                    ...
                                                    <td>
                                                        ...
                                                        <input type="file" name="user_files" class="add-user"/>
                                                    </td>
                                                    <td>
                                                    <label for="User Status">User Status</label>
                                                        <div class="form-check">
                                                        <input class="form-check-input" type="radio" name="userstatus" value="active" id="flexRadioDefault1" checked>
                                                            <label class="form-check-label" for="flexRadioDefault1">
                                                                Active
                                                            </label>
                                                            </div>
                                                            <div class="form-check">
                                                            <input class="form-check-input" type="radio" name="userstatus" value="inactive" id="flexRadioDefault2" >
                                                    ...
                                                    <tr>
                                                       <td>
                                                       <button type="submit" class="btn btn-warning add-user-submit">Submit</button>
                                                       </td>
                                                    </tr>
