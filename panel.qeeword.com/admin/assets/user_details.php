...
<body>
    <div class="app-container app-theme-white body-tabs-shadow fixed-sidebar fixed-header">
                        ...
                        <div class="row">
                                ...
                                <div class="card mb-3 widget-content bg-midnight-bloom">
                                    <div class="widget-content-wrapper text-white">
                                        <div class="widget-content-left">
                                            ...
                                            <div class="widget-subheading">Unique Countries</div>
                                        </div>
                                        <div class="widget-content-right">
                                            ...
                                            // Fetch the count of unique countries
                                            $unique_countries_query = "SELECT COUNT(DISTINCT user_ip) as unique_countries FROM search_logs";
                                            $unique_countries_result = mysqli_query($connect, $unique_countries_query);
                                            $unique_countries_count = mysqli_fetch_assoc($unique_countries_result)['unique_countries'];
                                        
                                            if ($user_count_data && $unique_countries_result) {
                                                ?>
                                                <div class="widget-numbers text-white">
                                                    <span style="font-size: 18px"><?php echo $total_search_count; ?></span>
                                                </div>
                                                <div class="widget-numbers text-white">
                                                    <span style="font-size: 18px"><?php echo $unique_countries_count; ?></span>
                                                </div>
                                                <?php
                                            }
                                            ?>
                            ...
                            <div class="col-md-6 col-xl-4">
                                <div class="card mb-3 widget-content bg-arielle-smile">
                                    <div class="widget-content-wrapper text-white">
                                        <div class="widget-content-left">
                                            <div class="widget-heading">Top Searched Country</div>
                                            <div class="widget-subheading">Total Searched</div>
                                        </div>
                                        <div class="widget-content-right" style="width:auto; text-right;">
                                        <?php
                                            // Fetch the counts for each country based on IP
                                            $country_counts = [];
                                            $countries_query = "SELECT user_ip, COUNT(*) as visit_count FROM search_logs WHERE search_query = '$searchQuery' GROUP BY user_ip";
                                            $countries_result = mysqli_query($connect, $countries_query);
                                            
                                            if ($countries_result && mysqli_num_rows($countries_result) > 0) {
                                                while ($row = mysqli_fetch_assoc($countries_result)) {
                                                    $country_counts[$row['user_ip']] = $row['visit_count'];
                                                }
                                            
                                                // Find the country with the maximum count
                                                $most_visited_country_ip = array_search(max($country_counts), $country_counts);
                                                $visit_count = max($country_counts);
                                            
                                                // Retrieve country name based on the most visited IP
                                                $apiKey = '7aedc5c16d99392ad3a43a9d83b07e13';
                                                $url = "http://api.ipstack.com/{$most_visited_country_ip}?access_key={$apiKey}";
                                                $ch = curl_init();
                                                ...
                                                $ipstackInfo = json_decode($response, true);
                                            
                                                // Display the country name
                                                $most_visited_country_name = isset($ipstackInfo['country_name']) ? $ipstackInfo['country_name'] : 'Unknown';
                                            
                                                ?>
                                                <div class="widget-numbers text-white">
                                                    <span style="font-size: 18px"><?php echo $most_visited_country_name; ?></span>
                                                </div>
                                                <div class="widget-numbers text-white" style="text-align:right;">
                                                    <span style="font-size: 18px"><?php echo $visit_count; ?> times</span>
                                                </div>
                                                <?php
                                            } else {
                                                // Handle case where there are no visits or an error occurred
                                                ?>
                            ...
                            <div class="col-md-6 col-xl-4">
                                <div class="card mb-3 widget-content bg-grow-early" style="height: 82px">
                                    <div class="widget-content-wrapper text-white">
                            ...
                            <div class="col-md-12">
                                <div class="main-card mb-3 cardmain-card-dashboard overFlow">
                                    <div class="card-header mb-card-h" style="display:flex; justify-content: space-between; align-items:center;">
                                        <span> Search Detail's for <?php echo $searchQuery; ?></span>
                                        <button onclick="printTable()" class="btn btn-success see-details-btn">Print Data</button>
                                    </div>
        ...
        <!-- JavaScript function to open the printDetails.php page in a new tab -->
        <script>
            function printTable() {
                // Get the current search query
                var searchQuery = "<?php echo $searchQuery; ?>";
        
                // Redirect to the print page with the search_query parameter, opening in a new tab
                window.open("printDetails.php?search_query=" + encodeURIComponent(searchQuery), "_blank");
            }
        </script>
    </body>
    </html>
