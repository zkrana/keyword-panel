                                    ...
                                    <div class="card-header mb-card-h" style="display:flex; justify-content: space-between; align-items:center;">
                                        ...
                                        <div class="table-responsive" style="background: white;">
                                            ...
                                            if (isset($_GET['email_id'])) {
                                                ...
                                                // Connect to the mailbox (similar to your previous code)
                                                ...
                                                // Fetch the email with the given email_id
                                                $email = imap_fetchbody($imap, $emailId, 1);
                                        
                                                // Close the mailbox connection
                                                imap_close($imap);
                                        
                                                // Display the email content in a simple HTML format
                                                echo '<html>';
                                                echo '<head><title>Reply Email</title></head>';
                                                echo '<body>';
                                        
                                                echo '<h1>Reply Email</h1>';
                                                echo '<p>Email content:</p>';
                                                echo '<div>' . nl2br(htmlspecialchars($email)) . '</div>'; // Display the email content
                                        
                                                // Create a reply form with a template
                                                echo '<form method="post" action="send_reply.php">'; // You need to create "send_reply.php" for sending the reply.
                                                echo '<input type="hidden" name="email_id" value="' . $emailId . '">';
                                                echo '<label for="reply_content">Reply:</label><br>';
                                                echo '<textarea name="reply_content" rows="6" cols="60">'; // Textarea for your reply
                                                echo "On " . date("F j, Y, g:i a") . ", " . htmlspecialchars($username) . " wrote:\n"; // Include a quote of the original email
                                                echo '----------------------------------'; // Separator
                                        
                                                echo '</textarea><br>';
                                                echo '<input style="background: #f7b924; margin-top: 10px; padding: 8px 25px; border: unset; border-radius: 4px; cursor: pointer;" type="submit" value="Send Reply">';
                                                echo '</form>';
                                        
                                                echo '</body>';
                                                echo '</html>';
                                            } else {
                                                echo 'Invalid email_id';
                                            }
                                            ?>
                                        </div>
                                    </div>
