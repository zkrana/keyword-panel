...
<head>
    ...
    $(document).ready(function(){
        $('.search-boxes input[type="text"]').on("keyup input", function(){
            /* Get input value on change */
            var inputVal = $(this).val();
            var resultDropdown = $(this).siblings(".result");
            if(inputVal.length){
                $.get("search.php", {terms: inputVal}).done(function(data){
                    // Display the returned data in browser
                    resultDropdown.html(data);
                });
            } else{
                        ...
                        <div class="app-page-title">
                            <div class="page-title-wrapper">
                                <div class="page-title-heading">
                                    ...
                                    <div>User Activity
                                        <div class="page-title-subheading">Welcome <?php echo ucfirst($login_session); ?>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="col-md-6 col-xl-4">
                            ...
                            <div class="col-md-6 col-xl-4">
                                <div class="card mb-3 widget-content bg-grow-early">
                                    <div class="widget-content-wrapper text-white">
                                        <a class="btn btn-success" href="dashboard.php">Go Back To Dashboard</a> 
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row user-form">
                            <div class="col-md-12">
                                <div class="main-card mb-3 card">
                                    <div class="card-header">Account Detail's
                                    ...
                                    <div class="table-responsive">
                                        <table class="table">
                                            ...
                                            // Fetch login activity for the current page
                                            $fetch_activity = "SELECT * FROM user_activity_log LIMIT $start_record, $records_per_page";
                                            $activity_query = mysqli_query($connect, $fetch_activity);
                                    
                                            while ($activity_row = mysqli_fetch_assoc($activity_query)) {
                                                echo "<tr>";
                                                echo "<td>{$activity_row['id']}</td>";
                                                echo "<td>{$activity_row['username']}</td>";
                                                echo "<td>{$activity_row['login_time']}</td>";
                                                echo "<td>{$activity_row['logout_time']}</td>";
                                                echo "</tr>";
                                            }
                                            ?>
                                            </tbody>
                                        ...
                                        $total_records = mysqli_num_rows(mysqli_query($connect, "SELECT * FROM user_activity_log"));
                                        ...
                                        if ($total_pages > 1) {
                                            if ($current_page > 1) {
                                                echo "<li class='page-item'><a class='page-link' href='user-activity.php?page=" . ($current_page - 1) . "'>Previous</a></li>";
                                            }
                                            ...
                                            for ($i = 1; $i <= $total_pages; $i++) {
                                                if ($i == $current_page) {
                                                    ...
                                                    echo "<li class='page-item'><a class='page-link' href='user-activity.php?page=$i'>$i</a></li>";
                                                }
                                            }
                                    
                                            if ($current_page < $total_pages) {
                                                echo "<li class='page-item'><a class='page-link' href='user-activity.php?page=" . ($current_page + 1) . "'>Next</a></li>";
                                            }
                                        }
                                        echo "</ul>";
                                        ?>
